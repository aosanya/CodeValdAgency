...
|--------|-------|----------|--------|--------|
| [BUG-20260609-001](bug-details/BUG-20260609-001_architecture_graph_missing_entities.md) | `architecture-graph.md` missing WorkPlan, AI*, and ContextSource entity types | Medium | 🚀 In Progress | [detail](bug-details/BUG-20260609-001_architecture_graph_missing_entities.md) |
